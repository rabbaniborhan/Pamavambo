    ...
    <section className="relative w-full py-24 bg-[#bc1a31] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        <p className="max-w-2xl mb-12 text-sm md:text-base leading-relaxed font-light opacity-90">
          Through House and Harkness, Pamavambo challenges a diverse community
          of promising young people to lead lives of learning, integrity, and
          high purpose. Our mission is to inspire the best in each to seek the
          best for all.
        </p>
