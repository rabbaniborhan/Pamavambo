...
const messages = [
  {
    ...
    content: (
      <div className="space-y-4 sm:space-y-5 md:space-y-6 text-xs sm:text-[13px] leading-relaxed text-gray-800 font-light">
        <p>
          The Pamavambo School is best experienced through the lens of the House
          System. Having gone to boarding school and worked at three other
          boarding schools, I can attest that the differentiating factor of
          Pamavambo is the magic within the House System. Not Harry Potter magic
          but the magical power of support, friendship, encouragement, trust,
          and growth that happens within a Pamavambo student's House experience.
        </p>
        <p>
          ...
          Additionally, my spouse teaches and coaches at Pamavambo. Every day,
          we actively choose to raise our family in Stephens.
        </p>
